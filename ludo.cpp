...
void display_msg(float x,float y,float z ,string msg)
{
...
{
  string about="This is the group semester project for Computer Graphics.";
	enter=0;
  int i;
